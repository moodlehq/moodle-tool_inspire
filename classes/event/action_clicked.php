...
class action_clicked extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'tool_inspire_predictions';
        $this->data['crud'] = 'r';
    ...
    public static function get_name() {
        return get_string('eventactionclicked', 'tool_inspire');
    }
    ...
    public function get_url() {
        return new \moodle_url('/admin/tool/inspire/prediction.php', array('id' => $this->objectid));
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'tool_inspire_predictions');
    }
}
