...
$string['insightincontext'] = 'New insight for "{$a->contextname}": {$a->insightname}';
$string['insightinfo'] = 'There are some insights you may find useful. Check out {$a}';
...
$string['target:coursedropout'] = 'Students at risk of dropping out a course';
